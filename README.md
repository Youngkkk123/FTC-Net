...
We prospectively collected 10 cases of follicular thyroid neoplasms, including 5 cases of FTA and 5 cases of FTC confirmed by surgical pathology. The data list is stored in `prospective_data.npy`.

Prospective_data can be evaluated with  using our model. The model has been uploaded to the web: https://pan.baidu.com/s/1JNtU9Ma8UwTP0hxe161-8w?pwd=x9bs.  key: x9bs.
